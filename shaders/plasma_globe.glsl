...
vec3 path(in float i, in float d)
{
    ...
    // Add audio reactivity to the wiggling arms
    float audioInfluence = texture(iAudioTexture, vec2(d * .05 + i * .1, .75)).r;
    sns2 += audioInfluence * 0.3;
    sns += audioInfluence * 0.25;
